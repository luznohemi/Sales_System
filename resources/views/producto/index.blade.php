...
<tbody>
    ...
    <tr  class="table-warning" >
        ...
        <td>  <a  class="btn btn-dark" href="{{ route('producto.editar', $producto->slug) }}">Editar</a> </td>
        <td> <a class="btn btn-dark" href="{{ route('producto.ver', $producto->slug) }}">Ver</a> </td>
        <td><a  class="btn btn-dark" href="" onclick="if(confirm('¿Eliminar {{ $producto->descripcion }} ?'))event.preventDefault();
